 ...
 *  
 *  ganti RTC 14-02-2022
 *  gunakan DS3231
 *  
 *  08-03-2022
 *  pilihan nada sampai 30(sebelumnya hanya 20)
 *  
 *  masukkan jadwal default sebelum upload program ini
 *  upload-kan file jadwal-eeprom.ino
*/
...
SoftwareSerial mySerial(2,3); //MP3
